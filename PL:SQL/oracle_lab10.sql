...
DECLARE lv_system_user_id Number;
BEGIN
  /* Call procedure once. */
  ...
  /*convert  system_user_name to system_user_id*/
  lv_system_user_id := account_creation.get_system_user_id(pv_user_name);
  account_creation.insert_contact(
      pv_first_name         => 'James'
    , pv_last_name          => 'Xavier'
    , pv_contact_type       => 'CUSTOMER'
